...
from .views import CreateRepoView, ShowRepoView, ShowListRepoView, ListCommitsView, home, ShowFileView, DiffCommit
...
urlpatterns = [
    ...
    path('diff/<str:username>/<str:repo>/<str:commit_a>/', DiffCommit.as_view(), name="repo_commit_compare_1"),
    path('diff/<str:username>/<str:repo>/<str:commit_a>/<str:commit_b>', DiffCommit.as_view(), name="repo_commit_compare_2"),
]
